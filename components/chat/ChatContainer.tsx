...
import { Button, Spin, Typography, Divider, Flex, Tooltip, Tag, Switch, InputNumber, Menu, message, Card, GetRef, GetProp, Alert, Dropdown, MenuProps, Masonry, Drawer } from 'antd';
import { CloudUploadOutlined, FileImageOutlined, PaperClipOutlined, ProfileOutlined, MenuOutlined } from '@ant-design/icons';
          ...
          <div className="space-y-3">
            ...
            <Flex justify="center" align="center" gap="small">
              <Button size="small" shape="round" color='geekblue' variant="filled"
                ...
                onClick={() => { handleOpenRedeem(); if (isMobile) setSidebarOpen(false); }}>
                兑换
              </Button>
              <Tooltip title="暂未开放">
            ...
            {!mounted ? (
              ...
              <Sender
                ...
                footer={(_, info) => {
                    ...
                    <Flex gap={btnCompact ? 4 : 'small'} align="center" wrap="wrap">
                      ...
                      <label className="cursor-pointer select-none">
                        <Tag style={{
                          ...
                          <Switch checked={keepPrompt} onChange={setKeepPrompt} size={btnCompact ? 'small' : 'medium'} />
                  ...
                  // 尺寸选择器
                  const sizeSelector = (
                    <SizeSelector value={imageSize} onChange={setImageSize} compact={selectorCompact} />
                  );
